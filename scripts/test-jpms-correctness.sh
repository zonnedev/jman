...
gson="${JMAN_GSON_DIR:-${project_dir}/target/integration-fixtures/gson-maven}"
...
JMAN_JAVA_LSP_DISABLE_ANNOTATION_PROCESSING=1 \
JMAN_JAVA_LSP_PROCESSOR_WORKER_CLASSPATH="${project_dir}/target/processor-worker.jar" \
